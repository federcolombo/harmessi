"""Adapter fino de Grok CLI (v0.5 Change 0). No verificado contra la CLI
real en este entorno (`grok` ausente de PATH al momento de escribir este
...
class GrokAdapter(ProviderAdapter):
    ...
    def invoke(self, request: InvocationRequest) -> InvocationResult:
        ...
        # `grok <prompt>` -- no verificado en este entorno por ausencia de
        # la CLI.
        cmd = [self.cli_command, request.prompt]
