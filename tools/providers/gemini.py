"""Adapter fino de Gemini CLI (v0.5 Change 0). No verificado contra la CLI
real en este entorno (`gemini` ausente de PATH al momento de escribir este
...
class GeminiAdapter(ProviderAdapter):
    ...
    def invoke(self, request: InvocationRequest) -> InvocationResult:
        ...
        # `gemini -p <prompt>` es el modo no interactivo documentado
        # públicamente -- no verificado en este entorno por ausencia de la
        # CLI.
        cmd = [self.cli_command, "-p", request.prompt]
